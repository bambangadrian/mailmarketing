...
class DssAlternativeController extends AbstractAdminController
{
    ...
    {
        $this->data['model'] = DssAlternative::notDeleted()->with('dss')->paginate(10);
    ...
    private function loadOptions()
    {
        ...
        $this->data['topicOptions'] = CampaignTopic::active()->notDeleted()->lists('Cto_Name', 'Cto_ID')->prepend('Please Alternative Reference ...', '');
    }
}
