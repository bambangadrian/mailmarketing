...
class MailScheduleController extends AbstractAdminController
{
    ...
    public function edit($id)
    {
        ...
        $this->data['model'] = MailSchedule::with('campaign', 'subscriberGroup', 'subscriberGroup.mailList')->find($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CreateSentCampaignRequest $request)
    {
        try {
            \DB::beginTransaction();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CreateSentCampaignRequest $request, $id)
    {
