            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('Sbr_Address1', null, ['class' => 'form-control', 'placeholder' => 'Enter Address 1', 'rows' => 3]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('Sbr_Address2', 'Address 2') !!}
                        {!! Form::textarea('Sbr_Address2', null, ['class' => 'form-control', 'placeholder' => 'Enter Address 2', 'rows' => 3]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('Sbr_Address3', 'Address 3') !!}
                        {!! Form::textarea('Sbr_Address3', null, ['class' => 'form-control', 'placeholder' => 'Enter Address 3', 'rows' => 3]) !!}
                    </div>
                </div>
            </div>
            <div class="row">
