...
@section('breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{ action('DashboardController@index') }}"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="#"><i class="fa fa-bookmark"></i> Mailing List</a></li>
    </ol>
@stop
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($model as $index => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $row->Mls_Address1 . ' ' . $row->Mls_Address2 }}
