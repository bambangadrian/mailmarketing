    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                {{--<div class="pull-left">--}}
                {{--<!-- User Image -->--}}
                {{--<img src="{{ asset("/vendor/bower_components/AdminLTE/dist/img/user2-160x160.jpg") }}"--}}
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ asset("/vendor/bower_components/AdminLTE/dist/img/avatar5.png") }}" class="user-image" alt="User Image">
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs">{{ Auth::user()->Usr_Name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ Auth::user()->Usr_Name }} - CBN
                                <small>{{ Auth::user()->Usr_Email }}</small>
                            </p>
                        </li>
