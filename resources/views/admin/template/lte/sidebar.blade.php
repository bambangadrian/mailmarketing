        ...
        <ul class="sidebar-menu">
            ...
            <li @if($activeMenu === 'mail')  class="active" @endif class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li @if($activeSubMenu === 'mailSchedule') class="active" @endif><a href="{{ action('Admin\CampaignScheduleController@index') }}"><i class="fa fa-calendar"></i> Scheduled Campaign</a></li>
                    ...
                    <li @if($activeSubMenu === 'mailSent') class="active" @endif><a href="{{ action('Admin\SentMailController@index') }}"><i class="fa fa-bar-chart"></i> Tracking Report</a></li>
                </ul>
            </li>
            <li @if($activeMenu === 'dss')  class="active" @endif class="treeview">
                ...
                <ul class="treeview-menu">
                    <li @if($activeSubMenu === 'dssPeriod') class="active" @endif><a href="{{ action('Admin\DssPeriodController@index') }}"><i class="fa fa-cube"></i> Period Item</a></li>
                    <li @if($activeSubMenu === 'dssCriteria') class="active" @endif><a href="{{ action('Admin\DssCriteriaController@index') }}"><i class="fa fa-server"></i> Criteria</a></li>
                    <li @if($activeSubMenu === 'dssAlternative') class="active" @endif><a href="{{ action('Admin\DssAlternativeController@index') }}"><i class="fa fa-gg"></i> Alternative</a></li>
                    <li @if($activeSubMenu === 'dssConsistency') class="active" @endif><a href="{{ action('Admin\DssConsistencyController@index') }}"><i class="fa fa-arrows-alt"></i> Consistency</a></li>
                    <li @if($activeSubMenu === 'dssPriority') class="active" @endif><a href="{{ action('Admin\DssPriorityController@index') }}"><i class="fa fa-sort-amount-asc"></i> Priority</a></li>
                    <li @if($activeSubMenu === 'dssResult') class="active" @endif><a href="{{ action('Admin\DssResultController@index') }}"><i class="fa fa-th-list"></i> Result</a></li>
                </ul>
            </li>
